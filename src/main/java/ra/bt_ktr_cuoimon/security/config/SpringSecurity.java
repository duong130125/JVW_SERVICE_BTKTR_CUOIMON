package ra.bt_ktr_cuoimon.security.config;
...
import ra.bt_ktr_cuoimon.security.jwt.JWTAuthFilter;
    ...
    public SecurityFilterChain configure(HttpSecurity http, JWTAuthFilter jWTAuthFilter) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/v1/product").hasAnyRole("ADMIN","CUSTOMER")
